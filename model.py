...
class SentimentAnalyzer:
    ...
    def calibrate_confidence(self, results_df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            # Map sentiment labels to 3-class model outputs
            ...
            results_df['confidence'] = calibrated_confidence
            
            # Update individual score columns
            results_df['Negative'] = calibrated_probs[:, 0]
            results_df['Neutral'] = calibrated_probs[:, 1]
            results_df['Positive'] = calibrated_probs[:, 2]
